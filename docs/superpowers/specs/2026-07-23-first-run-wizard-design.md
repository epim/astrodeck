...
test("WIZARD_STEPS never leaks the real backyard label", () => {
  ...
  assert(!blob.includes("Backyard") && !blob.includes("37.348"), "no private site data in copy");
});
