// monitor/sheets.ts - the MONITOR hub's sheet registry (ARCHITECTURE.md section 5).
//
// Empty until the MONITOR task fills it in. The export must exist now because
