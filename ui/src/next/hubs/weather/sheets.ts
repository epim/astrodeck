// weather/sheets.ts - the WEATHER hub's sheet registry (ARCHITECTURE.md section 5).
//
// Empty until the WEATHER task fills it in. The export must exist now because
