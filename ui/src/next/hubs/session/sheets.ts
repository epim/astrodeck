// session/sheets.ts - the SESSION hub's sheet registry (ARCHITECTURE.md section 5).
//
// Empty until the SESSION task fills it in. The export must exist now because
