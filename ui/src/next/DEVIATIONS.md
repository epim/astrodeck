...
`feat/ui-next`, `fec53970`..`3b23b9d5`, 109 commits ahead of `main`) departs
...
- **D-RIG-4** - A relative-offset nudge verb (RA/Dec, 1 arcmin to 10 degrees
  ...
  never two. Shipped: `cf839885`, `94e2affb`.
